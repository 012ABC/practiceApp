...
public class ColoredTextView extends AppCompatTextView {
    ...
    private static final int CORNER_RADIUS = ScreenUtils.dip2px(4);
    private static final int X_PADDING = (int) ScreenUtils.dip2px(16);
    private static final int Y_PADDING = ScreenUtils.dip2px(8);
